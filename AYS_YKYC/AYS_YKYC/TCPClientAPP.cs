...
namespace H07_YKYC
{
    public class ClientAPP
    {
        ...
        //测控网
        public static TCP_STRUCT ClientUSRP_Telecmd = new TCP_STRUCT();   //USRP遥控


        public static TCP_STRUCT ClientUSRP_Telemetry = new TCP_STRUCT();   //USRP遥测
        ...
        public static string LocalIP1;//与USRP连接
        public static string LocalIP2;//与瑞信丰连接
